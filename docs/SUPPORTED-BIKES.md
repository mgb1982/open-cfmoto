...
| **Moto Morini X-Cape 1200** | SoftAP / Yunmo joins. **2.0.14-pre / 70:** Setup ▸ bike profile **X-Cape 1200** (JPEG stills, adaptive quality). Auto stays on the old H.264 path. Discord `#xcape-1200` |
